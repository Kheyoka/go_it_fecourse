...
const finalPrice = +prompt('Сколько дроидов выхотите купить?');
const totalPrice = pricePerDroid * finalPrice;
...
if (finalPrice !== 0) {
    if (totalPrice > credits) {
        ...
        console.log(`Вы купили ${finalPrice}, на счету осталось ${credits - totalPrice}`);
    }
